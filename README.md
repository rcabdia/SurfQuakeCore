[![Python application](https://github.com/rcabdia/SurfQuakeCore/actions/workflows/python-app.yml/badge.svg)](https://github.com/rcabdia/SurfQuakeCore/actions/workflows/python-app.yml)
