...
class resolve_MT:
	...
	from surfquakecore.moment_tensor.sq_isola_tools.BayesISOLA._inverse import run_inversion, find_best_grid_point
	from surfquakecore.moment_tensor.sq_isola_tools.BayesISOLA._VR import VR_of_components
	from surfquakecore.moment_tensor.sq_isola_tools.BayesISOLA._print import print_solution, print_fault_planes
	from surfquakecore.moment_tensor.sq_isola_tools.BayesISOLA._save import save_seismo
