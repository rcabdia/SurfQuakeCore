...
class RealCore:
    ...
    def run_real(self):
        inventory = self._get_files_from_config(self.metadata_file)
        ...
        self._get_real_grid()
        tt_db = create_tt_db()
        tt_db.run_tt_db(dist=self.h_range, depth=self.parameters['geographic_frame']['depth'], ddist=0.01, ddep=1)