...
def load_real_configuration(config_file: str) -> RealConfig:
    ...
    return RealConfig(geographic_frame=GeographicFrame(lat_ref_max=Cast(real_config_ini['GEOGRAPHIC_FRAME']['LAT_REF_MAX'], float),
    lon_ref_max=Cast(real_config_ini['GEOGRAPHIC_FRAME']['LON_REF_MAX'], float), lat_ref_min=Cast(real_config_ini['GEOGRAPHIC_FRAME']['LAT_REF_MIN'], float),
    lon_ref_min=Cast(real_config_ini['GEOGRAPHIC_FRAME']['LON_REF_MIN'], float), depth=Cast(real_config_ini['GEOGRAPHIC_FRAME']['DEPTH'], float)),
    grid_search_parameters=GridSearch(horizontal_search_range=Cast(real_config_ini['GRID_SEARCH_PARAMETERS']['HORIZONTAL_SEARCH_RANGE'], float),
    ...
    horizontal_search_grid_size=Cast(real_config_ini['GRID_SEARCH_PARAMETERS']['HORIZONTAL_SEARCH_GRID_SIZE'], float),
    depth_search_grid_size=Cast(real_config_ini['GRID_SEARCH_PARAMETERS']['DEPTH_SEARCH_GRID_SIZE'], float)),
    travel_time_grid_search=TravelTimeGridSearch(horizontal_range=Cast(real_config_ini['TRAVEL_TIME_GRID_SEARCH']['HORIZONTAL_RANGE'], float),
